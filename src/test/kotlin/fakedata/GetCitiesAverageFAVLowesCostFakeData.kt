...
val cityEntityNullCase = CityEntity(
    cityName = "Maadi",
    country = "Egypt",
    mealsPrices = MealsPrices(
        mealInexpensiveRestaurant = 0.003508389f,
...
class FakeDataGetCitiesAverageFAVLowesCost : CostOfLivingDataSource {
    override fun getAllCitiesData() =
        listOf(cityEntityNullCase,cityEntity1, cityEntity2, cityEntity3,cityEntity4, cityEntity5, cityEntity6,cityEntity7, cityEntity8, cityEntity9,cityEntity10, cityEntity11, cityEntity12)
}