...
class FakeData : CostOfLivingDataSource {
    ...
    inner class EmptyDataSource : CostOfLivingDataSource {
        override fun getAllCitiesData() = emptyList<CityEntity>()
    }

    inner class MixedData : CostOfLivingDataSource {
    ...
    inner class LowQualityData : CostOfLivingDataSource {
        override fun getAllCitiesData() =
            listOf(
                CityEntity(
                    cityName = "Cairo",
    ...
    inner class NullData : CostOfLivingDataSource {
        override fun getAllCitiesData() =
