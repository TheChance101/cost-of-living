...
val city13 by lazy {
    CityEntity(
        ...
        averageMonthlyNetSalaryAfterTax = -100f,
        dataQuality = true
    )
}
val city14 by lazy {
    CityEntity(
        ...
        averageMonthlyNetSalaryAfterTax = -150f,
        dataQuality = true
    )
}
val city15 by lazy {
...
class NegativeInternetServiceProviderFakeData : CostOfLivingDataSource {
    override fun getAllCitiesData() = listOf(city13, city14, city15)
}
class NegativeSalaryServiceProviderFakeData : CostOfLivingDataSource {
    override fun getAllCitiesData() = listOf(city13, city14, city15)
}